        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pb-8 border-b border-[#E6E6E6] space-y-3">
            ...
            <p className="text-sm text-[#696969] max-w-2xl">
              Cita rasa legendaris Surakarta: Selat Solo, Timlo, Tengkleng, Nasi Liwet, Serabi Notosuman, hingga kuliner malam kekinian.
            </p>
          ...
          <div className="pt-8">
            {beritaList.length > 0 ? (
              ...
              <div className="bg-white border border-dashed border-gray-300 rounded-2xl p-12 text-center max-w-md mx-auto space-y-3">
                <p className="text-base font-semibold text-[#1D1D1D]">Belum ada berita kuliner</p>
                <p className="text-xs text-[#696969]">
                  Belum terdapat artikel untuk kategori Kuliner.
                </p>
              </div>
            )}
          </div>
